    ...
    <div className='w-full min-h-screen bg-[#1A55A5] flex justify-center items-center bg-[url("../src/assets/bgLogin.svg")] bg-no-repeat bg-center '>
      ...
      <Card className="p-5 m-3 md:m-0">
        <CardHeader className="flex flex-col w-full items-center">
          <img
            className="sm:mb-[5px] md:mb-[10px] xl:mb-[15px] mb-[30px] sm:w-[80px] md:w-[80px] xl:w-[110px] w-[143px] sm:h-[70px] md:h-[80px] xl:h-[100px] h-[120px]"
            src="../src/assets/logo.svg"
            alt=""
          />
          <CardTitle className="text-[15px] md:text-[20px] xl:text-[25px]">
            Welcome!
          </CardTitle>
          <CardDescription className="text-[13px] md:text-[15px]">
            Sign in to continue.
          </CardDescription>
        </CardHeader>
        ...
        <CardContent>
          {/* Email or Username */}
          <p className="text-[12px] md:text-[14px] mb-1">Email or Username</p>
          ...
          {/* Password */}
          <p className="text-[12px] md:text-[14px] mt-3 mb-1">Password</p>
          <div className="relative">
